...
if 'VGG16' in gallery_selection:
    if 'SGD' in gallery_selection:
        ...
        if '0.001' in gallery_selection:
            model_name1 = 'StaticGallery/LR=0.001/loss_surface_cifar10_vgg16_Adam_epochs=100_BS=128_LR=0.001_BETA1=0.9_BETA2=0.999_WD=0_axes=ON_log=ON.png'
            model_name2 = 'StaticGallery/LR=0.001/loss_surface_cifar10_vgg16_Adam_IKSA_epochs=100_BS=128_SEED=1234_LR=0.001_BETA1=0.9_BETA2=0.999_WD=0_'
        elif '0.005' in gallery_selection:
            model_name1 = 'StaticGallery/LR=0.005/loss_surface_cifar10_vgg16_Adam_epochs=100_BS=128_LR=0.005_BETA1=0.9_BETA2=0.999_WD=0_axes=ON_log=ON.png'
            model_name2 = 'StaticGallery/LR=0.005/loss_surface_cifar10_vgg16_Adam_IKSA_epochs=100_BS=128_SEED=1234_LR=0.005_BETA1=0.9_BETA2=0.999_WD=0_'
    ...
    model_name1 = 'StaticGallery/resnet110_noshort/loss_surface_cifar10_resnet56_noshort_SGD_epochs=100_BS=128_LR=0.05_MOM=0.9_WD=0.0005_axes=ON_log=ON.png'
    model_name2 = 'StaticGallery/resnet110_noshort/loss_surface_cifar10_resnet56_noshort_SGD_IKSA_epochs=100_BS=128_SEED=1234_LR=0.05_MOM=0.9_WD=0.0005_'
